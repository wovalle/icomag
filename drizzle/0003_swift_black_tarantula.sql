...
INSERT INTO `__new_transactions`("id", "type", "amount", "description", "date", "owner_id", "bank_account_id", "reference", "category", "serial", "bank_description", "batch_id", "is_duplicate", "created_at", "updated_at") SELECT "id", "type", "amount", "description", "date", "owner_id", "bank_account_id", "reference", "category", "serial", "bank_description", "batch_id", "is_duplicate", "created_at", "updated_at" FROM `transactions`;--> statement-breakpoint
